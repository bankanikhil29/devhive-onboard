            ...
            <div className="hidden lg:block relative min-h-[500px] flex items-center">
              <div className="relative w-full">
                ...
                <div className="relative rounded-2xl overflow-visible shadow-2xl">
                  ...
                  <div className="absolute -bottom-4 -left-6 p-3 rounded-lg bg-marketing-navy-light/95 backdrop-blur-sm border border-marketing-teal/30 shadow-2xl shadow-marketing-teal/10 animate-float">
                    <div className="flex items-center gap-2">
                      <div className="w-10 h-10 rounded-lg bg-marketing-teal/20 flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-marketing-teal">
